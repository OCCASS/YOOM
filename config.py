...
BTN_SENSITIVITY = 'Sensitivity'
SENSITIVITY_LOW, SENSITIVITY_MEDIUM, SENSITIVITY_HIGH = 'low', 'medium', 'high'
BTN_MUSIC = 'Music'
SENSITIVITY_LOW_POS = (110, 250)
SENSITIVITY_MEDIUM_POS = (210, 250)
SENSITIVITY_HIGH_POS = (360, 250)